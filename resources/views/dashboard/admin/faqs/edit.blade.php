...
@section('title', __('general.Update FAQ'))
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('general.Update FAQ') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('admin.faqs.update', $faq->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <!-- Question Arabic -->
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question_ar" id="question_ar" value="{{ old('question_ar', $faq->question_ar) }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="question_en" id="question_en" value="{{ old('question_en', $faq->question_en) }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="answer_ar" id="answer_ar"
                                                  ...
                                                  rows="3" required>{{ old('answer_ar', $faq->answer_ar) }}</textarea>
                                        @error('answer_ar')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="answer_en" id="answer_en"
                                                  ...
                                                  rows="3" required>{{ old('answer_en', $faq->answer_en) }}</textarea>
                                        @error('answer_en')
                                        <span class="col-form-label-sm text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
