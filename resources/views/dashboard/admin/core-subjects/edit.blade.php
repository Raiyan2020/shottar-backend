...
@section('title', __('general.Edit Core Subject'))
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('general.Edit Core Subject') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('admin.core-subjects.update', $coreSubject->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $coreSubject->name_ar) }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $coreSubject->name_en) }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        @if($coreSubject->image)
                                            <img src="{{ image_url($coreSubject->image) }}" width="80" class="mt-1" alt="">
                                        @endif
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-check form-switch mt-4">
                                        <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ old('status', $coreSubject->status) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="status">{{ __('dataTable.status') }}</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary">{{ __('general.Update') }}</button>
                                    <a href="{{ route('admin.core-subjects.index') }}" class="btn btn-secondary">{{ __('general.cancel') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
