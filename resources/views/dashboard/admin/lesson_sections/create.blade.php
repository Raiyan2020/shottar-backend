...
@section('title', __('general.Add Lesson Section') )
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('general.Add Lesson Section') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route(panelPrefix().'.subjects.sections.store', $subject->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <!-- Subject ID (Hidden) -->
