...
@section('title', __('Update Study Type') )
@section('css')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{__('general.Update Study Type')}} </h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('admin.study-types.update', $studyType->id) }}" method="post" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <!-- Name Arabic -->
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            value="{{ old('name_ar', $studyType->name_ar) }}"
                                            name="name_ar"
                                            type="text"
                                            id="name_ar"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            value="{{ old('name_en', $studyType->name_en) }}"
                                            name="name_en"
                                            type="text"
                                            id="name_en"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            required
                                        >
                                            <option value="1" {{ old('status', $studyType->status ?? '') == true ? 'selected' : '' }}>{{ __('general.Active') }}</option>
                                            <option value="0" {{ old('status', $studyType->status ?? '') == false ? 'selected' : '' }}>{{ __('general.Inactive') }}</option>
                                        </select>
                                        @error('status')
