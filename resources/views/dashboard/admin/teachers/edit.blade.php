            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title">
                            {{ __('general.Edit Teacher') }} — {{ $teacher->name }}
                        </h4>
                    </div>

                    <div class="card-body">
                        <form class="form" action="{{ route('admin.teachers.update', $teacher->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                {{-- الاسم --}}
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('name', $teacher->name) }}" name="name" type="text" id="name"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('email', $teacher->email) }}" type="email" id="email" name="email"
                                ...
                                {{-- كلمة المرور + تأكيد (اختياري) --}}
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="col-form-label-sm" for="password">
                                            {{ __('general.Password') }} ({{ __('general.optional') }})
                                        </label>
...
{{--                                                {{ __('general.Current') }}: {{ basename($teacher->image) }}--}}
{{--                                            </small>--}}
{{--                                        @endif--}}
                                ...
                                <div class="col-12">
                                    ...
                                    @php
                                        $oldSelected = old('subject_ids', $selectedSubjectIds ?? []);
                                    @endphp
