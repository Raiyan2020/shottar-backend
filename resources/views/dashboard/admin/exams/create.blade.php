...
@section('title', __('general.Add Exam'))
@section('css')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="lesson_section_id" id="lesson_section_id"
                                            ...
                                            @foreach($sections as $section)
                                                <option value="{{ $section->id }}" {{ (string) old('lesson_section_id', '') === (string) $section->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="is_free" id="is_free" class="form-control form-control-sm">
                                            <option value="0" @selected(old('is_free', '0') == '0')>{{ __('general.No') }}</option>
                                            <option value="1" @selected(old('is_free') == '1')>{{ __('general.Yes') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control form-control-sm">
                                            <option value="1" @selected(old('status', '1') == '1')>{{ __('general.Active') }}</option>
                                            <option value="0" @selected(old('status') == '0')>{{ __('general.Inactive') }}</option>
                                        </select>
                                    </div>
                                </div>
