...
return [
    ...
    */
    ...
    'myfatoorah' => [
        ...
        // مفتاح الـ Webhook Secret من بوابة MyFatoorah (Webhook V2). لازم يتفعّل
        // "Secure Key" في صفحة الـ webhook بالبورتال ويتنسخ نفس القيمة هنا،
        // وإلا التحقق من التوقيع (MyFatoorah-Signature) هيفشل على طول.
