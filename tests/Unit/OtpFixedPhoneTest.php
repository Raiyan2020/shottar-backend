...
{
    public function test_global_fixed_otp_applies_to_every_phone(): void
    {
        config([
            'services.otp.fixed_code' => '1234',
            'services.otp.fixed_phones' => '',
        ]);

        $this->assertSame(1234, generate_activation_code('+201091626965'));
        $this->assertSame(1234, generate_activation_code('+96555558718'));
        $this->assertTrue(uses_fixed_otp('+96555558718'));
    }
    ...
    public function test_fixed_otp_for_egyptian_test_number(): void
    {
        config([
            ...
            'services.otp.fixed_phones' => '201091626965:1234',
        ]);
